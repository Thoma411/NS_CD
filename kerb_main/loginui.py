...
#                 self.c_grade.append(row[4])
#                 self.m_grade.append(row[5])
#                 self.e_grade.append(row[6])
#                 self.total.append(row[7])
#                 self.ave.append(row[8])
#             # print(self.id)
#             # print(self.name)
#             # print(self.gender)
#             # print(self.age)
...
#                        self.var_c_grade.get(), self.var_m_grade.get(), self.var_e_grade.get(),
#                        float(self.var_c_grade.get()) + float(self.var_m_grade.get()) + float(self.var_e_grade.get()),
#                        (float(self.var_c_grade.get()) + float(self.var_m_grade.get()) + float(
#                            self.var_e_grade.get())) / 3
#                        )  # SQL 插入语句
#                 try:
...
# 				 WHERE id = '%s'" % (
#                     self.var_name.get(), self.var_gender.get(), self.var_age.get(),
#                     self.var_c_grade.get(), self.var_m_grade.get(), self.var_e_grade.get(),
#                     float(self.var_c_grade.get()) + float(self.var_m_grade.get()) + float(self.var_e_grade.get()),
